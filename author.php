...
<?php
	/* Queue the first post, that way we know who the author is when we try to get their name, URL, description, avatar, etc. We reset this later so we can run the loop properly with a call to rewind_posts(). */
	if ( have_posts() )
		the_post();
?>
